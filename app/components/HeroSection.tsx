...
export default function HeroSection() {
    return (
        <div className="w-full px-3 xl:px-8 2xl:px-12 grid lg:grid-cols-2 pt-22 lg:pt-33 space-y-6 lg:space-y-0">
            <div className="lg:border-r lg:pr-3 border-[#00000027]">
                <div className="w-full h-[300px] xl:h-[350px] 2xl:h-[400px] relative overflow-hidden rounded-md">
                    <Image src="/demo-image-1.webp" alt="" fill className="rounded-md object-cover hover:scale-105 transition-all duration-500" />
                </div>
                <h1 className="font-bold text-3xl lg:text-5xl pt-4 pb-2 hover:text-[#0000008d] transition-all duration-300">How Music Tours Create Unforgettable Moments</h1>
                <p className="text-[#525252] leading-tight text-sm lg:text-base line-clamp-2">In the Age of Information, news media faces both unprecedented opportunities and significant challenges.</p>
                <div className="w-full border-b border-[#00000027] my-2 lg:my-4"></div>
            ...
            <div className="lg:pl-3 grid lg:grid-cols-2">
